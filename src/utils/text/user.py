...
"""
SUPPORT_TEXT_NOT_FOUND = '❗️ Информация о Технической Поддержки отсутствует ❗️'
PRICES_TEXT_NOT_FOUND = '❗️ Информация о Ценах отсутствует ❗️'
ABOUT_TEAM_TEXT_NOT_FOUND = '❗️ Информация о Команде отсутствует ❗️'
